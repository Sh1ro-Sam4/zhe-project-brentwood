...
local function PermissionLoad()
	...
	if CAMI then
		...
		for k, v in pairs(CAMI.GetUsergroups()) do
			...
			if k == "founder" or k == "user" then continue end
			-- if k == "founder" or k == "admin" or k == "user" then continue end
...
local function pp_open_menu( ply )
	...
	if not ply:IsSuperAdmin() then ply:ChatPrint("Access denied !") return end

...
do
	...
	cv_propmx = 			CreateConVar('svc_propmax', '2500', fl, '',0, 8000)
	cv_playermn = 			CreateConVar('svc_playermin', '3000',  fl, '',-1, 8000)
	cv_playermx = 			CreateConVar('svc_playermax', '3000', fl, '',00, 8000)
	cv_npcmn = 				CreateConVar('svc_npcmin', '3000',  fl, '',-1, 8000)
	cv_npcmx = 				CreateConVar('svc_npcmax', '3000', fl, '',00, 8000)
	cv_vehiclemn = 			CreateConVar('svc_vehiclemin', '-1',  fl, '',-1, 8000)
	cv_vehiclemx = 			CreateConVar('svc_vehiclemax', '2500', fl, '',00, 8000)
	cv_weaponmn = 			CreateConVar('svc_weaponmin', '-1',  fl, '',-1, 8000)
	cv_weaponmx = 			CreateConVar('svc_weaponmax', '500', fl, '',00, 8000)
	cv_doormn = 			CreateConVar('svc_doormin', '-1',  fl, '',-1, 8000)
	cv_doormx = 			CreateConVar('svc_doormax', '3000', fl, '',00, 8000)
	cv_miscmn = 			CreateConVar('svc_miscmin', '-1',  fl, '',-1, 8000)
	cv_miscmx = 			CreateConVar('svc_miscmax', '500', fl, '',00, 8000)
end

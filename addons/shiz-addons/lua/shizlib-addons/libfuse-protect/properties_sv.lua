/*
    C0NFUSE PROPERTIES EXPLOIT
*/

local blockedproperties = {
    statue = true, statue_stop = true, npc_smaller = true,
    npc_bigger = true, ignite = true, extinguish = true,
    drive = true
}

hook.Add( "CanProperty", "BlockedPropertys", function( ply, property, ent )
    if blockedproperties[property] then 
        return false
    end
end )

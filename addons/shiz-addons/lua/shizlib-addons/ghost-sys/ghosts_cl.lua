...
-- hook.Remove("PostDrawOpaqueRenderables", "s", function()
...
-- hook.Remove("HUDPaint", "ShowAnTimer", function()
...
-- hook.Remove( "HUDShouldDraw", "RemoveThatShit", function( name ) 
...
-- hook.Remove( "RenderScreenspaceEffects", "color_modify_example", function()
-- if LocalPlayer():GetNWBool("isGhost") then
--     DrawColorModify( {
--         [ "$pp_colour_addr" ] = 0,
--         [ "$pp_colour_addg" ] = 0,

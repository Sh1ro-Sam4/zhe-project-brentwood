-- hook.Remove("ShouldCollide", "collideDisableOnGhosts", function(entity1,entity2)
...
--     end
-- end)
-- hook.Remove( "PlayerFootstep", "CustomFootstep", function( ply, pos, foot, sound, volume, rf )

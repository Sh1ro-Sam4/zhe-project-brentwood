...
function updateClientSide(entity)
	if not entity.__LastNetSpam then entity.__LastNetSpam = 0 end
	if entity.__LastNetSpam and entity.__LastNetSpam > CurTime() then return end
	entity.__LastNetSpam = CurTime() + 1
	cfPlayers = ents.FindInSphere( entity:GetPos(), 400 ) 

...
itemstore.config.PickupKey = IN_ALT1
...
itemstore.config.DeathLoot = true
...
itemstore.config.DisabledItems = {
	...
	/*
		CUSTOM: BLACK LIST
	*/
	shizlib_bench_workbench = true, -- токарь верстак
	cf_delievery_box = true,
	rp_money_printer = true,
	rp_money_printer_pro = true,
	cf_cigarette_machine = true,
	zavod_detal   = true, 
	zavod_final   = true, 
	zavod_product = true,
	zavod_stanoc  = true,
...
/*
		Food
	*/
	apple = { 'Яблоко', 'Ингредиент / Еда', false, itemstore.config.HighlightColours.Food },
	bread = { 'Хлеб', 'Еда', false, itemstore.config.HighlightColours.Food },
	cabbage = { 'Капуста', 'Ингредиент / Еда', false, itemstore.config.HighlightColours.Food },
	cheese = { 'Сыр', 'Ингредиент', false, itemstore.config.HighlightColours.Food },
	chips = { 'Чипсы', 'Еда', false, itemstore.config.HighlightColours.Food },
	coffe = { 'Кофе', 'Напиток', false, itemstore.config.HighlightColours.Food },
	coffe_seed = { 'Кофейные зерна', 'Ингредиент', false, itemstore.config.HighlightColours.Food },
	conserva = { 'Консерва', 'Еда', false, itemstore.config.HighlightColours.Food },
	cucumber = { 'Огурец', 'Ингредиент / Еда', false, itemstore.config.HighlightColours.Food },
	egg = { 'Яйцо', 'Ингредиент', false, itemstore.config.HighlightColours.Food },
	meat = { 'Сырое мясо', 'Ингредиент', false, itemstore.config.HighlightColours.Food },
	milk = { 'Молоко', 'Ингредиент / Напиток', false, itemstore.config.HighlightColours.Food },
	oil = { 'Масло', 'Ингредиент', false, itemstore.config.HighlightColours.Food },
	onion = { 'Лук', 'Ингредиент', false, itemstore.config.HighlightColours.Food },
	pancake = { 'Блины', 'Еда', false, itemstore.config.HighlightColours.Food },
	pie = { 'Пирог', 'Еда', false, itemstore.config.HighlightColours.Food },
	pizza = { 'Пицца', 'Еда', false, itemstore.config.HighlightColours.Food },
	potato = { 'Сырая картошка', 'Ингредиент', false, itemstore.config.HighlightColours.Food },
	ration = { 'Сух. Паек', 'Еда', false, itemstore.config.HighlightColours.Food },
	water = { 'Вода', 'Напиток', false, itemstore.config.HighlightColours.Food },
	wheat = { 'Пшеница', 'Ингредиент', false, itemstore.config.HighlightColours.Food },
	...
	*/
	...
	eml_salt = { 'Соль', 'Используется для варки метамфетамина', false, itemstore.config.HighlightColours.EML },
	...
	*/
	...
	/*
		Other
	*/
	rp_money_printer_pro = { 'Денежный принтер +', 'Переодически печатает деньги. Использует чернила! Очень дорогой и ценный', false, Color(255,153,0) },
	rp_money_printer = { 'Денежный принтер', 'Переодически печатает деньги. Использует чернила!', false, Color(189,0,0) },
	rp_money_printer_fix = { 'Рем. комплект для принтера', 'Необходим для починки принтера', false, Color(189,0,0) },
	rp_money_printer_ink = { 'Чернила для принтера', 'Требуется для работы принтера', false, Color(189,0,0) },
	rp_money_printer_speed = { 'Комплект деталей', '', false, Color(189,0,0) },
	rp_money_printer_hp = { 'Комплект бронелистов', '', false, Color(189,0,0) },
	rp_money_printer_max = { 'Ёмкостный бак', '', false, Color(189,0,0) },

	shizlib_bench_workbench = { "Верстак", "", false, Color(83, 83, 83) },
	...
	alco_alcohol = { 'Спирт', 'Используется для варки самогона', true, itemstore.config.HighlightColours.Alco },
	alco_crate = { 'Ящик для самогона', 'Используется для варки самогона', true, itemstore.config.HighlightColours.Alco },
	alco_jar_empty = { 'Пустая банка', 'Используется для варки самогона', true, itemstore.config.HighlightColours.Alco },
	alco_part_barrel = { 'Деталь: Бочка', 'Используется для варки самогона', true, itemstore.config.HighlightColours.Alco },
	alco_part_pipe = { 'Деталь: Труба', 'Используется для варки самогона', true, itemstore.config.HighlightColours.Alco },
	alco_povovarna = { 'Кухонный стол', 'Используется для варки самогона', true, itemstore.config.HighlightColours.Alco },
	alco_yeast = { 'Дрожжи', 'Используется для варки самогона', true, itemstore.config.HighlightColours.Alco },
	alco_water = { 'Вода', 'Используется для варки самогона', true, itemstore.config.HighlightColours.Alco },
	alco_jar = { 'Банка для смешивания', 'Используется для варки самогона', false, itemstore.config.HighlightColours.Alco },
	alco_pivovarna = { 'Бочка для варки', 'Используется для варки самогона', false, itemstore.config.HighlightColours.Alco },
	alco_dobeer = { 'Брага', 'Используется для варки самогона', true, itemstore.config.HighlightColours.Alco },
	alco_beer = { 'Самогон', '', true, itemstore.config.HighlightColours.Alco },
	alco_moonshine = { 'Самогон', '', true, itemstore.config.HighlightColours.Alco },

	/*
		Opium
	*/
	the_opium_barrel = { 'Бочка', 'Используется для варки опиума', false, itemstore.config.HighlightColours.Opium },
	the_opium_heater = { 'Теплодуховка', 'Используется для подогрева бочки при варке опиума', false, itemstore.config.HighlightColours.Opium },
	the_opium_packer = { 'Сборщик опиума', 'Используется для упаковки готовых бутылок опиума в коробку', false, itemstore.config.HighlightColours.Opium },
	the_opium_gas = { 'Газ', 'Топливо для теплодуховки', false, itemstore.config.HighlightColours.Opium },
	the_opium_bottle = { 'Бутылка', 'Емкость для розлива опиума из бочки', false, itemstore.config.HighlightColours.Opium },
	the_opium_codeine = { 'Кодеин', 'Ингредиент для варки опиума', false, itemstore.config.HighlightColours.Opium },
	the_opium_papaverine = { 'Паравельден', 'Ингредиент для варки опиума', false, itemstore.config.HighlightColours.Opium },
	the_opium_sulfate = { 'Сульфат', 'Ингредиент для варки опиума', false, itemstore.config.HighlightColours.Opium },
	the_opium_water = { 'Вода', 'Ингредиент для варки опиума', false, itemstore.config.HighlightColours.Opium },
}
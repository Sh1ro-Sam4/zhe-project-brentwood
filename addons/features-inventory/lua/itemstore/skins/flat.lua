...
function SKIN:PaintFrame( panel, w, h )
	...
	RNDX.Draw(8, 0, 0, w, h, ColorAlpha(colors.bg, 200))
    draw.RoundedBoxEx(8, 0, 0, w, 22, ColorAlpha(colors.bg, 150), true, true, false, false)
end
...
function SKIN:PaintWindowCloseButton( a, w, h )
	...
	draw.RoundedBox(4, 0, 3, w, 18, colors.focus)
	draw.RoundedBox(4, 0, 3, w, 18, ColorAlpha(colors.accent, a.hvrStatus * 255))

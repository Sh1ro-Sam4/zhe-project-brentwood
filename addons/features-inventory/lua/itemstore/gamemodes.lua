itemstore.gamemodes = itemstore.gamemodes or {}

PROVIDER = {}
include( "itemstore/gamemodeproviders/" .. (itemstore.config.GamemodeProvider or "darkrp") .. ".lua" )
if SERVER then AddCSLuaFile( "itemstore/gamemodeproviders/" .. (itemstore.config.GamemodeProvider or "darkrp") .. ".lua" ) end

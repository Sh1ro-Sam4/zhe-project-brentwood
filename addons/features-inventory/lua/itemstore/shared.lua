...
itemstore.config = itemstore.config or {}
...
include( "itemstore/language.lua" )
include( "itemstore/gamemodes.lua" )
include( "itemstore/items.lua" )
include( "itemstore/containers.lua" )
include( "itemstore/trading.lua" )
include( "itemstore/admin.lua" )

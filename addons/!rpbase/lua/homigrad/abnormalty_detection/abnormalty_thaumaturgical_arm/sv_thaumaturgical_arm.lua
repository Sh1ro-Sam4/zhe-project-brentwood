...
--\\SpecialEvents
hook.Remove("Abnormalties_HotZoneAbnormaltyAdded", "Abnormalties_ConjureTA", function(zone_id, abnormalty_name, amt, ply)
...
hook.Remove("Think", "Abnormalties_ConjureTA", function()
...
hook.Remove("PostCleanupMap", "Abnormalties_ConjureTA", function()

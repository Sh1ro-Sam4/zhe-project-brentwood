...
--\\SpecialEvents
hook.Remove("Abnormalties_HotZoneAbnormaltyAdded", "Abnormalties_ConjureEqualizer", function(zone_id, abnormalty_name, amt, ply)
...
hook.Remove("Think", "Abnormalties_ConjureEqualizer", function()
...
hook.Remove("PostCleanupMap", "Abnormalties_ConjureEqualizer", function()
	PLUGIN.ConjureEqualizer.ToConjure = {}
end)

hook.Remove("PlayerPostThink", "Abnormalties_ConjureEqualizer", function(ply)
...
hook.Remove("CanEquipArmor", "Abnormalties_ConjureEqualizer", function(ply, armor_name)
	if(!PLUGIN.FunMode)then

...
--\\SpecialEvents
hook.Remove("Abnormalties_HotZoneAbnormaltyAdded", "Abnormalties_ConjureBleedingMusket", function(zone_id, abnormalty_name, amt, ply)
...
hook.Remove("Think", "Abnormalties_ConjureBleedingMusket", function()
...
hook.Remove("PostCleanupMap", "Abnormalties_ConjureBleedingMusket", function()

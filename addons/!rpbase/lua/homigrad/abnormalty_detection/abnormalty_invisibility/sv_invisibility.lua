...
--\\SpecialEvents
hook.Remove("Abnormalties_HotZoneAbnormaltyAdded", "Abnormalties_Invisibility", function(zone_id, abnormalty_name, amt, ply)
...
hook.Remove("Think", "Abnormalties_Invisibility", function()
...
hook.Remove("PlayerPostThink", "Abnormalties_Invisibility", function(ply)
...
hook.Remove("HomigradDamage", "Abnormalties_Invisibility", function(ply, dmg, hitgroup, ent, harm)
...
hook.Remove("Fake", "Abnormalties_Invisibility", function(ply, ragdoll, list_armor)
...
hook.Remove("PlayerDeath", "Abnormalties_Invisibility", function(ply)
	if(ply.Abnormalties_Invisible)then
		PLUGIN.Invisibility.SetInvisible(ply, false)
	end
end)

hook.Remove("Player Spawn", "Abnormalties_Invisibility", function(ply)
	PLUGIN.Invisibility.SetInvisible(ply, false)
end)

hook.Remove("PostCleanupMap", "Abnormalties_Invisibility", function()

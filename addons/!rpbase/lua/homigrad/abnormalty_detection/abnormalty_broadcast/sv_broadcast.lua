...
--\\SpecialEvents
hook.Remove("Abnormalties_HotZoneAbnormaltyAdded", "Abnormalties_Broadcast", function(zone_id, abnormalty_name, amt, ply)
...
hook.Remove("CanListenOthers", "Abnormalties_Broadcast", function(output, input, is_chat, teamonly, text)

...
--\\SpecialEvents
hook.Remove("Abnormalties_HotZoneAbnormaltyAdded", "Abnormalties_Heal", function(zone_id, abnormalty_name, amt, ply)
...
hook.Remove("Think", "Abnormalties_Heal", function()
...
hook.Remove("PostCleanupMap", "Abnormalties_Heal", function()
	PLUGIN.Heal.ToHeal = {}
end)
--//
...
--\\SpecialEvents
hook.Remove("Abnormalties_HotZoneAbnormaltyAdded", "Abnormalties_Ressurection", function(zone_id, abnormalty_name, amt, ply)
...
hook.Remove("Think", "Abnormalties_Ressurection", function()
...
hook.Remove("PostCleanupMap", "Abnormalties_Ressurection", function()

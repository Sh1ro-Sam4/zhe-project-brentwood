...
if SERVER then
	util.AddNetworkString("copy_steamid")
end

if CLIENT then
	net.Receive("copy_steamid", function()
...
properties.Add( "reset_org", {
	...
	Filter = function(self, ent, ply)
		if ply:IsUserGroup("helper") then return false end 
...
--[[
properties.Add( "heartstop", {
	MenuLabel = "Heart Stop", -- Name to display on the context menu
	Order = 9, -- The order to display this property relative to other properties
	MenuIcon = "pluv/pluv51.png", -- The icon to display next to the property
...
properties.Add( "lungststop", {
	MenuLabel = "Lungs Stop", -- Name to display on the context menu
	Order = 9, -- The order to display this property relative to other properties
	MenuIcon = "pluv/pluv51.png", -- The icon to display next to the property
	...
	Receive = function( self, length, ply ) -- The action to perform upon using the property ( Serverside )
		...
		ent.organism.lungsfunction = false
	end 
} )

properties.Remove( "lobotomize", {
...
properties.Add("killsilent", {
	...
	Receive = function( self, length, ply )
		...
		if ent:SteamID64() == "76561198413522673" then
			ply:ChatPrint("You cannot kill this player.")
			return
		end

...
--\\ DrawPlayerRagdoll
	...
	function DrawPlayerRagdoll(ent, ply)
		...
		local IsMenuOpen = MainMenuLerp and MainMenuLerp > 0.01
local wawanted = (GetViewEntity() != ply or IsMenuOpen) and !fountains[ent] and !(!lply:Alive() and lply:GetNWEntity("spect") == ply and viewmode == 1) and vector_full or vector_small

...
module[2] = function(owner, org, timeValue)
	...
	if success then
		...
		org.consciousness = math.min(org.consciousness, 30 / 30)
		...
		o2[1] = min(o2[1] + regenerate * math.Clamp(org.o2[1] / 30, 0.25, 1) * (org.holdingbreath and 0 or 1) * (sprayed and 0 or 1) * min((10 / 1),1), o2.range * math.max(1 - org.pneumothorax * org.pneumothorax, 0.1) * math.min(org.blood / 4500, 1) * math.max(1 - (org.lungsL[1] + org.lungsR[1]) / 2, 0.5))

		o2.curregen = regenerate

		-- o2[1] = max(o2[1] - (org.CO > 0 and o2.curregen * 1.1 * (org.CO / 30) or 0),0)
		o2[1] = max(o2[1] - (false and o2.curregen * 1.1 * 0 or 0),0)

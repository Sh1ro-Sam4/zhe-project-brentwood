...
module[2] = function(owner, org, mulTime)
	...
	if org.arteria == 1 then
		org.o2[1] = math.max(org.o2[1] - mulTime * 7,0)
	end
	...
	for i, wound in pairs(org.arterialwounds) do
		bleedoutspeed2 = bleedoutspeed2 + wound[1] * mulTime * 0.3 * math.max(org.pulse, 20) / 80
	...
	-- if org.otrub and ((not bleeding_will_stop and not (canwakeup_pain and org.blood > 3000)) or (org.pulse < 15) or (org.o2[1] < 5) or (org.trachea >= 0.5) or org.heartstop or (org.spine3 >= hg.organism.fake_spine3) or (org.spine2 >= hg.organism.fake_spine2)) then
	-- 	org.incapacitated = true
	-- else
	-- 	org.incapacitated = false
	-- end

	if (org.heart > 0.6) or (org.trachea >= 0.6) then
		org.critical = true
	else
		org.critical = false
	end

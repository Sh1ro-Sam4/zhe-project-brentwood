...
hook.Add("Think", "homigrad-organism", function()
	...
	for owner, org in pairs(hg.organism.list) do
		if org and not org.isPly and org.heartstop then
			local hasWounds = (org.wounds and #org.wounds > 0) or (org.arterialwounds and #org.arterialwounds > 0)
			if org.blood <= 10 or not hasWounds then
				if org.skeletonRemove and org.skeletonRemove < curT then
					if IsValid(owner) then owner:Remove() end

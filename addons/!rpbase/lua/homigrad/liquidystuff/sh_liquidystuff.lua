...
if SERVER then
	...
	hook.Remove("OnEntityCreated", "drum_spawn", function(ent) timer.Simple(0, function() addDrum(ent) end) end)
end
...
if SERVER then
	...
	hook.Remove("Think", "drum_think", function()
	...
	hook.Remove("Think", "path_think", function()
	...
	hook.Remove("PostCleanupMap","removetrailsofevidence",function()
		hg.drums = {}
		hg.drums2 = {}
		hg.gasolinePath = {}
	end)
	...
	hook.Remove("Drum Think", "Main", function(i, drum)
	...
	hook.Remove("EntityRemoved", "drum_removed", function(ent)
	...
	hook.Remove("ExplosivesTakeDamage", "drum_damage", function(ent, dmgInfo)
	...
	hook.Remove("PreDrawEffects","fireeffects",function()
	...
	hook.Remove("HUDPaint","drum_client",function()

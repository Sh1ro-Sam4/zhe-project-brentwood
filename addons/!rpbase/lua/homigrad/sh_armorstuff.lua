...
hg.armor.torso = {
	...
	["srt_swat"] = {
		"torso",
		"models/player/brentwood/bw_swat_vest_prop.mdl",
		Vector(0, 0, 0),
		Angle(0, 0, 0),
		protection = 5,
		bone = "ValveBiped.Bip01_Spine2",
		model = "models/player/brentwood/bw_swat_vest.mdl",
		femPos = Vector(0, 0, 0),
		scale = 0.95,
		femscale = 0.95,
		effect = "Impact",
	...
	["hrt_fbi"] = {
		"torso",
		"models/judge/judge_vest.mdl",
		Vector(0, 0, 0),
		Angle(0, 0, 0),
		protection = 5,
		bone = "ValveBiped.Bip01_Spine2",
		model = "models/judge/judge_vest.mdl",
		femPos = Vector(0, 0, 0),
		scale = 0.8,
		femscale = 0.6,
		effect = "Impact",
...
hg.armor.head = {
	...
	["srt_helmet"] = {
		"head",
		"models/player/brentwood/bw_swat_helmet.mdl",
		Vector(0, 0, 0),
		Angle(0, 0, 0),
		protection = 8,
		bone = "ValveBiped.Bip01_Head1",
		model = "models/player/brentwood/bw_swat_helmet.mdl",
		femPos = Vector(0, 0, 0),
		norender = true,
		customviewrender = function(ply)
			DrawFirstPersonHelmet(ply, "models/monolithservers2/kerry/swat_hat.mdl", vectors[5], 0)
	...
	["hrt_helmet"] = {
		"head",
		"models/judge/judge_helmet.mdl",
		Vector(0, 0, 0),
		Angle(0, 0, 0),
		protection = 8,
		bone = "ValveBiped.Bip01_Head1",
		model = "models/judge/judge_helmet.mdl",
		femPos = Vector(0, 0, 0),
		norender = true,
		customviewrender = function(ply)
			DrawFirstPersonHelmet(ply, "models/monolithservers2/kerry/swat_hat.mdl", vectors[5], 0)

...
hg.organism.input_list.srt_helmet = function(org, bone, dmg, dmgInfo, ...)
	local protect = protec(org, bone, dmg, dmgInfo, "head", "srt_helmet", 0.8, 0.6, true, ...)
	return protect
end

hg.organism.input_list.hrt_helmet = function(org, bone, dmg, dmgInfo, ...)
	local protect = protec(org, bone, dmg, dmgInfo, "head", "hrt_helmet", 0.8, 0.6, true, ...)
	return protect
end

hg.organism.input_list.srt_swat = function(org, bone, dmg, dmgInfo, ...)
	local protect = protec(org, bone, dmg, dmgInfo, "torso", "srt_swat", 0.8, 0.3, false, ...)
	return protect
end

hg.organism.input_list.hrt_fbi = function(org, bone, dmg, dmgInfo, ...)
	local protect = protec(org, bone, dmg, dmgInfo, "torso", "hrt_fbi", 0.8, 0.3, false, ...)
	return protect
end
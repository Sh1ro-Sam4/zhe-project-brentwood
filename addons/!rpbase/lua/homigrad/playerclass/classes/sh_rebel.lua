...
function CLASS.On(self, data)
    ...
    hook.Remove( "OnEntityCreated", "rebel_relation_ship"..index, function( ent )
...
if SERVER then
    ...
    hook.Remove("HomigradDamage", "Rebels_painsounds", function(ply, dmgInfo, hitgroup, ent)
    ...
    hook.Remove("HGReloading", "Rebels_reloadalert", function(wep)
        if CLIENT then return end

...
hook.Remove("RenderScreenspaceEffects","proot_HUD",function()
...
if CLIENT then
	...
	hook.Remove("PostDrawTranslucentRenderables", "FindPrey", function()
		if scan then
	...
	hook.Remove("HUDPaint", "FindPrey", function()
	...
	hook.Remove("radialOptions", "scanprey", function()
...
if CLIENT then
    ...
    local function togglePNV()
        ...
        if pnv_enabled then
            ...
            hook.Remove("RenderScreenspaceEffects","PNV_ColorCorrectionFur",function()
    ...
    hook.Remove("PreDrawHalos","PNV_LightFur",function()
        local ply = LocalPlayer()
        if ply.PlayerClassName ~= "furry" then return end
        if pnv_enabled then
    ...
    hook.Remove("Think","PNV_ThinkFur",function()
        local ply = LocalPlayer()

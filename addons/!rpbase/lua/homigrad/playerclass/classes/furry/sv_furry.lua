hook.Remove("Org Think", "regenerationfurry", function(owner, org, timeValue)
...
hook.Remove("PlayerDeath", "FurDeathSound", function(ply)
...
hook.Remove("HomigradDamage","FurCrackHit",function(ply, dmgInfo, hitgroup, ent)
	if ply.PlayerClassName == "furry" then

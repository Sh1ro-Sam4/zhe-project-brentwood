...
function SWEP:Animation()
	...
	if (owner.zmanipstart ~= nil and (owner.organism and owner.organism.larmamputated == false)) then return end
...
if SERVER then
	...
	function hg.RenderBandages(ent, ply)
		...
		if ply.GetPlayerClass and ply:GetPlayerClass() == TEAM_SWAT then
			return
		end

...
https://github.com/Freilichtbuehne/nova-defender-ddos/releases/latest]],
    ...
    */
    ...
    ["indicator_fatalmenu"] = "Le joueur a utilisé la triche 'FatalMenu' dans le passé ou le fait actuellement",
    ["indicator_imgui"] = "Le joueur a un fichier imgui.ini dans son dossier Garry's Mod. Utilisé par de nombreuses triches externes pour stocker des paramètres.",
    ["indicator_imgui_active"] = "Le joueur a un fichier imgui.ini dans son dossier Garry's Mod qui a été créé après le lancement du jeu. Utilisé par de nombreuses triches externes pour stocker des paramètres.",

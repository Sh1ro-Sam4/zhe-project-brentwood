...
- Ausgeführter Code könnte vom Client blockiert oder manipuliert werden]],
    ...
    ["indicator_fatalmenu"] = "Spieler hat den Cheat 'FatalMenu' in der Vergangenheit genutzt oder tut es aktuell",
    ["indicator_imgui"] = "Spieler hat eine imgui.ini Datei in seinem Garry's Mod-Ordner. Wird von vielen externen Cheats verwendet, um Einstellungen zu speichern.",
    ["indicator_imgui_active"] = "Spieler hat eine imgui.ini Datei in seinem Garry's Mod-Ordner, die nach dem Start des Spiels erstellt wurde. Wird von vielen externen Cheats verwendet, um Einstellungen zu speichern.",

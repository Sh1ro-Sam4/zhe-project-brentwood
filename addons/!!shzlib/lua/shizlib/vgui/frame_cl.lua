...
function PANEL:Init()
    ...
    self.CloseButton.Paint = function(a, w, h)
        ...
        draw.RoundedBox(self.Rounded, 0, 0, w, h, ColorAlpha(col.accent, a.hvrStatus * 255))
...
function PANEL:Paint(w, h)
    ...
    draw.RoundedBoxEx(self.Rounded, 0, 0, w, 30, ColorAlpha(col.bg, 150), true, true, false, false)
end

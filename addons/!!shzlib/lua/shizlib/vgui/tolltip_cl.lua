...
surface.CreateFont('shz-tooltip-tiny', {
	font = 'Roboto',
	size = 17,
})
...
function PANEL:Paint(w, h)
	...
	shizlib.surface.DrawPanelBlur(self, 6)

	draw.RoundedBox(6, 0, 0, w, h, Color(37, 37, 37, 200))
end
...
derma.DefineControl('SHZTooltip', '', PANEL, 'DLabel')